...
const _routes = [
  {
    ...
    component: () => import("./nuxt/index-C8puHes1.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./nuxt/default-B1FJRtGq.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./nuxt/error-404-CVHZz3X6.js").then((r) => r.default || r));
