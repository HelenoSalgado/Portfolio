import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, isReadonly, defineComponent, computed, provide, Suspense, nextTick, mergeProps, Transition, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./nuxt/index-DnznLl-s.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./nuxt/default-CxJY63HS.js").then((m) => m.default || m)
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { public: pub } = /* @__PURE__ */ useRuntimeConfig();
    const title = computed(
      () => route.meta.title ? `Salop Web | ${route.meta.title}` : "Salop Web"
    );
    useHead({
      titleTemplate: (titleChunk) => {
        if (titleChunk == null ? void 0 : titleChunk.includes("|")) return titleChunk;
        return title.value;
      }
    });
    useSeoMeta({
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./nuxt/error-404-C0eFHCi7.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./nuxt/error-500-Bfg8QqmI.js").then((r) => r.default || r));
